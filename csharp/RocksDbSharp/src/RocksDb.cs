...
namespace RocksDbSharp
{
    ...
    public class RocksDb : IDisposable
    {
        ...
        {
            var handle = Native.Instance.rocksdb_get_updates_since(this.Handle, sequenceNumber, IntPtr.Zero, out var errptr);
            if (errptr != IntPtr.Zero)
                return null;

            return new TransactionLogIterator(this, handle, sequenceNumber);
        }
        ...
        public ulong GetLastSequenceNumber()
        {
